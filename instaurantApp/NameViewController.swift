...
class NameViewController: UIViewController {
    ...
    @objc func handleRegister(sender: UIButton){
        ...
        sender.alpha = 0.4
        sender.setTitle("Add the Name", for: .normal)
        print(text.text!)
        nameProtocol?.setName(name: text.text!)
//        let detailedVC = NewViewController()
//        navigationController?.pushViewController(detailedVC, animated: true)
    ...
    override func viewDidLoad() {
        ...
        text.attributedPlaceholder = NSAttributedString(string: "Enter the Name of restaurant")
        ...
        button.setTitle("Add the Name", for: UIControl.State.normal)
